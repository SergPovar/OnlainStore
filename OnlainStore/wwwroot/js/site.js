 var newCatA = $("a#newcata"); /*Класс линка добавления*/
        ...
        ajaxText.html("<span class='alert alert-danger' style='margin-left: 180px'  >That title is taken!</span>");
        setTimeout(function () {
        ajaxText.fadeOut("fast", function () {
        ajaxText.html(" <img  src='~/IMG/no-image.png'/>")
           
            // <img src='https://i.gifer.com/XOsX.gif' height='50' />
    });
    }, 2000);
        return false;
    }
        ...
        ajaxText.html("<span class='alert alert-success' style='margin-left: 180px'>The category has been added!</span>");
        setTimeout(function () {
        ajaxText.fadeOut("fast", function () {
        ajaxText.html("<img src='https://i.gifer.com/XOsX.gif' height='50' />");
    });
    }, 2000);
